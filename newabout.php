    ...
    <div class="container heroabout">
        <div class="row">
            <div class="col-sm-12 col-lg-8">
                ...
                <div>
                    <span id="vidplayer" style="display: none;"><video id="video1" style="margin:auto;" loop>
                        ...
                        <figcaption id="cap6"> Fantaisie Impromptu by Chopin</caption>
                    </span></div>


                <div id="img1" style="display:none;"> <img src="images/titles.png" class="thumb1-img"></img></div>
                <div id="img2" style="display:none;"><img src="images/fka1.png" class="thumb-img"></img>
                    <figcaption>FKA Twigs; musician, dancer, fashion icon</figcaption>
                </div>
                <div id="img3" style="display:none;"><img src="images/wcon.JPG" class="thumb-img"></img>
                    <figcaption>Me and my sister Connie (I'm on the right)</figcaption>
                </div>
                <div id="img4" style="display:none;"><img src="images/run.jpg" class="thumb-img"></img>
                    <figcaption>I love half marathons</figcaption>
                </div>
            ...
            <div class="col-sm-4 col-lg-4">
                <img src="/images/prof3.png" class="about-img" alt="A black and white photo of a girl wearing a sweater, smiling."></img>
            </div>
