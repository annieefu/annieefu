...
<a class="button rainbow" target="_blank" href="https://docs.google.com/document/d/1DE8x5yv_yAG_LjyCeb79bHNPISB6Db7MklDySlKjm20/edit?usp=sharing">Read the Op-Ed</a>
  ...
  <section id="services" class="sec-writing sec">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2>Op-Ed: Racial Protest and Retaliation</h2>
          <hr color="lightgrey"/>
        </div>
        <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-6">
          <p>
          "While some adults may perceive silent protest as a form of disrespect or an action intended to incite violence, the main message that young children receive from bashing Kaepernick or others is that unique opinion is bad." <ul class="hero-deets">
<li><strong>Role:</strong> Regional Policy Intern for Michigan Roundtable</li>
<li><strong>Date:</strong> Spring 2017</li>
</ul></p>
<p class="halfspace">
<a class="button rainbow" target="_blank" href="https://docs.google.com/document/d/17d9Ihj-yCa26U9YZ3f-gSBsuY8CuRhJHWYuiHLzCzBI/edit?usp=sharing">Read the Op-Ed</a>
         </p>
        </div>

        <div class="col-xs-12 col-md-6 col-lg-6">
          <p>
          <a href="https://docs.google.com/document/d/17d9Ihj-yCa26U9YZ3f-gSBsuY8CuRhJHWYuiHLzCzBI/edit?usp=sharing" alt ="A preview image of a typed word document." target="_blank"> <img class="project-img" src="images/opedkaep.png" /></a>
</p>
        </div>
        </div>
      </div>
