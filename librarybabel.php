...
<li><strong>My Role:</strong> Unreal Engine Developer, Interaction Designer</li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-left">
          <h1>Brainstorming</h1>
          <h3> We started off with three initial ideas...</h3>
          <hr />
        </div>
      </div>
    <div class="container-fluid">
    ...
    <q> The library will endure; it is the universe. As for us, everything has not been written; we are not turning into phantoms. 
      ...
      <div class="row">
        ...
        <p class="text-center"> 2</p>
          ...
          <p> There are few cinematic environments as haunting as the Tesserect of <em>Interstellar,</em> an enclosed yet infinite space for communication
          through gravity. </p><p>
