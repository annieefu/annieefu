...
<body class="home">
<div class="bodybin">
<h2 class="headingEDIT container space">Borges's Library of Babel</h2>
</div>
<ul class="hero-deets">
    ...
    <q> The library will endure; it is the universe. As for us, everything has not been written; we are not turning into phantoms. 
      ...
      <div class="row">
        <div class="col-xs-12 col-md-4 text-left">
          ...
          <p class="text-center"> 1</p>
          <img src = "images/lib-bab.jpg" alt = "a greyscale picture of a vast library"  class="portfolio-img text-center"></img><p>
        ...
        <p class="text-center"> 2</p>
          <img src = "images/lib-bab2.jpeg" alt = "a futuristic 'library' with shelves and light stretching in a glitching effect"  class="portfolio-img text-center"></img>
          
          <p> In <em>Interstellar,</em> it's possible to
          move within a fifth dimension capable of transcending linear time. Matthew McConaughey's character pulls physical, chronological strings 
        ...
        <p class="text-center"> 3</p>
          ...
          <img src = "images/lib-bab3.png" alt = " a magical library bursting of light, with a glowing orb in the middle"  class="portfolio-img text-center"></img>
          

          <p> Pinterest remains a reliable tool for idea generation. The initial stages of our project drew notable elements from different illustrated libraries,
            including materials, lighting, and spacial design.
          </p><br>
        </div>
      </div>
</div>
      ...
      <div class="row ">
        ...
        <div class="col-xs-12 col-lg-8 col-md-8">
          ...
          <hr color="white"/>
            ...
            <p class="text-center"> We formed <strong>three word clouds</strong> to
